...
Gera etiquetas para conjuntos de coletas, coleções ou lotes.

Entrada esperada:

Planilha organizada com dados de conjuntos, coleções e intervalos.

Saída:

Etiquetas em lote para coleções ou conjuntos de materiais.
...
```html
assets/css/layout.css?v=20260528aa
js/app.js?v=20260528aa
```
...
```html
<link rel="stylesheet" href="../shared/tool-standard.css?v=20260529a">
```
...
3. EVB Labels Collection
   - Gerar etiquetas para conjuntos, coletas ou coleções.
...
- Se um arquivo estiver em `.xls` em vez de `.xlsx`, atualize o caminho em `data/site-data.js`.
...
```html
<link rel="stylesheet" href="assets/css/layout.css?v=20260528aa">
<script defer src="js/app.js?v=20260528aa"></script>
```
...
Existem arquivos de logo aparentemente antigos em:
...
Eles não parecem ser usados pelo portal principal atualmente. Foram mantidos para evitar apagar possíveis backups.
