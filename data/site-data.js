...
const tools = [
    ...
    {
        id: "mapa-coordenadas",
        name: "Mapa & Coordenadas",
        category: "Georreferenciamento",
        description: "Plota coordenadas em mapa interativo, permite filtrar e buscar registros, avalia completude espacial, converte coordenadas e apoia o georreferenciamento de registros sem coordenada.",
        accepts: "Planilhas .xls, .xlsx ou .csv com coordenadas decimais ou campos em graus, minutos e segundos.",
        output: "Mapa interativo, tabela copiavel, planilha atualizada em .xlsx, lista de pontos, filtros, busca, legenda dinamica, relatorio espacial e conversoes de coordenadas.",
        status: "Estavel",
        version: "2.0",
    ...
    },
    {
        ...
        description: "Converte planilhas autorais, JABOT e PELD/RAPELD Vegetacao para uma estrutura Darwin Core voltada a flora, preservando campos verbatim e gerando relatorio local de validacao.",
        accepts: "Planilhas .xls, .xlsx ou .csv com dados botanicos, geograficos, curatoriais, taxonomicos ou dados de parcelas PELD/RAPELD.",
        output: "Planilha Darwin Core com preview, sheet de mapeamento, relatorio auxiliar e, no perfil PELD/RAPELD, aba MeasurementOrFact.",
        status: "Estavel",
        version: "1.0",
...
const toolLongDescriptions = {
    ...
    `,
    "mapa-coordenadas": `
        <p>A ferramenta <strong>Mapa & Coordenadas</strong> foi criada para concentrar as funções espaciais em uma interface própria, independente do EVB DataCheck.</p>
        ...
        <p>O mapa possui camadas base, visualizacao por satelite, agrupamento de pontos, filtros, busca, legenda interativa e lista de pontos visiveis. A tabela carregada pode ser visualizada abaixo do mapa, copiada para revisao em planilhas externas ou exportada novamente em formato <strong>.xlsx</strong>.</p>
        <p>A ferramenta tambem inclui um modulo inicial de <strong>georreferenciamento assistido</strong>. Nesse fluxo, o usuario seleciona um registro sem coordenadas, usa as informacoes de coleta para aproximar a localidade, consulta pistas de registros do mesmo coletor com coordenadas, desenha no mapa a area provavel de ocorrencia e aplica a coordenada estimada nos campos JABOT de latitude, longitude e GMS.</p>
        <p>A ferramenta tambem funciona como conversor de coordenadas. O usuario pode converter uma coordenada individual entre decimal e GMS, plotar uma coordenada digitada manualmente e converter lotes de coordenadas, gerando uma tabela pronta para copiar e colar em planilhas externas.</p>
        <p>Esse modulo e util tanto para revisao de planilhas botanicas quanto para tarefas rapidas de georreferenciamento, conferencia de campo, organizacao de coordenadas e preparacao de dados espaciais para outras analises.</p>
    `,
    "specieslink-jabot": `
    ...
    `,
    "evb-darwincore": `
        <p>A ferramenta <strong>EVB DarwinCore</strong> foi criada para padronizar planilhas botanicas autorais ou no modelo JABOT em uma estrutura compativel com o Darwin Core, com foco inicial em dados de flora.</p>
        <p>O objetivo principal desta primeira versao e automatizar a passagem de um formato de trabalho interno para um formato mais universal de exibicao, intercambio e compartilhamento de dados, sem perder o rastro do que estava escrito originalmente na planilha de origem.</p>
        <p>Por isso, a ferramenta preserva sempre que possivel campos <strong>verbatim</strong>, especialmente relacionados a nome cientifico, data, localidade e coordenadas. Ao mesmo tempo em que produz colunas padronizadas do Darwin Core, ela guarda tambem a forma original do dado quando essa informacao existe na planilha ou pode ser reconstruida com seguranca.</p>
        <p>A versao atual aceita planilhas em <strong>.xls</strong>, <strong>.xlsx</strong> e <strong>.csv</strong>, tenta reconhecer automaticamente o perfil de entrada e trabalha especialmente bem com duas situacoes: planilhas no modelo JABOT e planilhas autorais com colunas taxonomicas, geograficas e curatoriais minimamente reconheciveis.</p>
        <p>Durante a conversao, a ferramenta monta uma planilha Darwin Core com preview imediato, gera uma folha auxiliar de mapeamento entre colunas de origem e termos finais, produz um relatorio local de validacao e permite exportar o resultado em <strong>.xlsx</strong> ou <strong>.csv</strong>.</p>
        <p>O perfil <strong>PELD/RAPELD Vegetacao</strong> reconhece planilhas de parcelas com modulo, parcela, lado, faixa, subparcela, plaqueta, taxonomia, DAP, altura, POM, flags e posicoes locais X/Y. Nesses casos, a ferramenta gera uma tabela principal de ocorrencias e uma aba <strong>MeasurementOrFact</strong> com as medidas associadas a cada individuo.</p>
        <p>Esta primeira etapa ainda nao substitui uma validacao taxonomica mais robusta. Ela entrega o nucleo estrutural: padronizacao, preservacao de verbatim, revisao local e preparacao do conjunto para passos posteriores, como matching taxonomico, checagem contra backbone externo e uso em plataformas de biodiversidade.</p>
    `
};
...
const toolHelp = {
    flow: [
        ...
        },
        {
            ...
            tool: "EVB DarwinCore",
            text: "Converta planilhas autorais ou no modelo JABOT para uma estrutura Darwin Core com campos verbatim preservados, preview e relatorio local de validacao."
        }
    ],
    tools: [
        {
        ...
        },
        {
            ...
            steps: [
                "Abra Mapa & Coordenadas.",
                "Carregue a planilha JABOT ou uma planilha com coordenadas reconheciveis.",
                "Confira os pontos no mapa, filtros, busca e completude espacial.",
                "Confira a tabela abaixo do mapa e copie o conteudo quando precisar revisar os dados em uma planilha externa.",
                "Use o conversor individual ou em lote quando precisar padronizar coordenadas."
            ],
            commonErrors: [
                "Usar coordenadas gerais de municipio em vez das coordenadas reais de coleta.",
        ...
        },
        {
            ...
            expectedInput: "Planilhas autorais, planilhas no modelo JABOT, planilhas parcialmente alinhadas ao Darwin Core ou planilhas PELD/RAPELD de vegetacao, com dados taxonomicos, geograficos, curatoriais ou de parcelas.",
            steps: [
                "Abra EVB DarwinCore.",
                "Carregue a planilha .xls, .xlsx ou .csv que deseja padronizar.",
                ...
                "Execute a conversao para gerar a planilha Darwin Core com preservacao de campos verbatim. Para PELD/RAPELD, revise tambem a aba MeasurementOrFact.",
            ...
            commonErrors: [
                ...
                "Campos geograficos muito incompletos para montar country, stateProvince, county e locality com seguranca.",
                "Planilhas autorais com nomes de colunas muito idiossincraticos exigindo revisao manual depois da conversao."
            ]
        }
    ]
};
        ...
        sections: [
            ...
            },
            {
                ...
                body: [
                    ...
                    "A digitalização produz uma representação permanente do exemplar, exigindo nitidez, enquadramento adequado e nomeação correta dos arquivos. Em seguida, duplicatas devem ser separadas, o material pode passar por congelamento preventivo e, por fim, ser organizado fisicamente no acervo."
                ],
                items: [
    ...
    en: {
        tools: [
            ...
            },
            {
                ...
                output: "Interactive map, copy-ready table, visible point list, filters, search, dynamic legend, spatial report and coordinate conversions.",
                status: "Stable",
                exampleLabel: "Sample spreadsheet"
            },
            {
            ...
            },
            {
                ...
                accepts: ".xls, .xlsx or .csv spreadsheets with botanical, taxonomic, geographic and curatorial data.",
        ...
        toolHelp: {
            flow: [
                ...
                { step: "5", title: "Check coordinates", tool: "Map & Coordinates", text: "Plot records, review spatial completeness, filter points and convert coordinates in decimal or DMS format." },
                { step: "6", title: "Convert speciesLink", tool: "SpeciesLink to JABOT", text: "Convert Darwin Core spreadsheets exported from speciesLink into the JABOT format before checking and incorporation." },
                { step: "7", title: "Standardize Darwin Core", tool: "EVB DarwinCore", text: "Convert authorial or JABOT spreadsheets into a Darwin Core structure with preserved verbatim fields, local validation and export sheets." }
            ],
            tools: [
                {
                    toolId: "jabot-extract",
                ...
                },
                {
                    ...
                    steps: ["Open Map & Coordinates.", "Load the JABOT spreadsheet or another spreadsheet with recognizable coordinates.", "Check points, filters, search and spatial completeness on the map.", "Review the table below the map and copy it when data need external review.", "Use the individual or batch converter when coordinates need standardization."],
                ...
                {
                    toolId: "evb-darwincore",
                    expectedInput: "Authorial spreadsheets, JABOT spreadsheets or partially Darwin Core-like sheets with botanical, taxonomic, geographic and curatorial data.",
                    steps: ["Open EVB DarwinCore.", "Load the .xls, .xlsx or .csv spreadsheet to standardize.", "Choose the automatic, JABOT, authorial or partial Darwin Core reading profile.", "Fill in the main dataset metadata such as datasetName, institutionCode, collectionCode, basisOfRecord, license and rightsHolder.", "Run the conversion to generate a Darwin Core sheet with preserved verbatim fields.", "Review preview, local warnings and the mapping sheet before exporting the final file."],
                    commonErrors: ["Missing scientificName or a name built only partially from genus and epithet.", "Missing, invalid or unexpectedly placed coordinates.", "Geographic fields too incomplete to safely populate country, stateProvince, county and locality.", "Authorial spreadsheets with highly idiosyncratic column names requiring manual review after conversion."],
        ...
        serviceItems: [
            {
                ...
                description: "Reserved space for general guidance for new team members, interns, undergraduate research students and collaborators beginning work at the herbarium.",
                status: "In preparation"
            },
            {
                title: "Herborization processes",
                description: "Reserved space to describe the future steps of collecting, pressing, drying, mounting, sewing, labeling, photographing and storing botanical material.",
                status: "In preparation"
            },
            {
                title: "Material incorporation",
                description: "Initial guidance for undergraduate thesis students, research students and EVB-linked projects on how to organize collection data and prepare material for incorporation into the collection.",
                status: "Template soon",
        ...
        orientationGuides: [
            {
                ...
                title: "Good practices guide",
                status: "In preparation",
                summary: "Entry point for new team members, interns, undergraduate research students and collaborators.",
                sections: [
                    {
                        title: "Introduction to the space",
                        body: [
                            "Reserved space to present the general organization of the herbarium, work areas, responsible team and first guidance for people beginning activities at EVB.",
                            "When the final guide is written, this chapter may include photos of the room, cabinets, sorting area and circulation spaces."
                        ],
                        items: ["Who to contact when arriving at the herbarium.", "Which areas can be accessed freely.", "Which activities require team supervision."]
                    },
                    {
                    ...
                    },
                    {
                        ...
                        items: ["Record completed activities.", "Report pending tasks to the person responsible for the routine.", "Separate materials that require review."]
                    }
                ]
            },
            {
                ...
                title: "Herborization processes",
                status: "In preparation",
                summary: "Steps for collection, pressing, drying, mounting, labeling and storage of botanical material.",
                sections: [
                    {
                    ...
                    },
                    {
                        ...
                        items: ["Check whether material is dry before mounting.", "Ensure that the label matches the specimen.", "Separate incomplete material for review."]
                    }
                ]
            },
            {
                ...
                sections: [
                    ...
                    },
                    {
                        ...
                        items: ["Separate duplicates when available.", "Keep collection number and collector linked to the specimen.", "Indicate materials with identification doubts."]
                    },
                    {
    ...
    es: {
        tools: [
            ...
            },
            {
                ...
                output: "Mapa interactivo, tabla lista para copiar, lista de puntos visibles, filtros, busqueda, leyenda dinamica, informe espacial y conversiones de coordenadas.",
                status: "Estable",
                exampleLabel: "Planilla de ejemplo"
            },
            {
            ...
            },
            {
                ...
                accepts: "Planillas .xls, .xlsx o .csv con datos botanicos, taxonomicos, geograficos y curatoriales.",
        ...
        toolHelp: {
            flow: [
                ...
                { step: "4", title: "Analizar datos", tool: "EVB DataCheck", text: "Cargue una planilla en el modelo JABOT para producir estadisticas, graficos, mapas, listas floristicas e informe interpretativo." },
                { step: "5", title: "Revisar coordenadas", tool: "Mapa y Coordenadas", text: "Represente puntos, revise la completitud espacial, filtre registros y convierta coordenadas en formato decimal o GMS." },
                { step: "6", title: "Convertir speciesLink", tool: "SpeciesLink para JABOT", text: "Convierta planillas Darwin Core exportadas de speciesLink al estandar JABOT antes de la revision e incorporacion." },
                { step: "7", title: "Estandarizar Darwin Core", tool: "EVB DarwinCore", text: "Convierta planillas autorales o JABOT a una estructura Darwin Core con campos verbatim preservados, validacion local y hojas auxiliares." }
            ],
            tools: [
                {
                    toolId: "jabot-extract",
                ...
                },
                {
                    ...
                    steps: ["Abra Mapa y Coordenadas.", "Cargue la planilla JABOT u otra planilla con coordenadas reconocibles.", "Revise los puntos, filtros, busqueda y completitud espacial en el mapa.", "Revise la tabla debajo del mapa y copiela cuando necesite revisar los datos externamente.", "Use el conversor individual o por lote cuando necesite estandarizar coordenadas."],
                    commonErrors: ["Usar coordenadas generales de municipio en vez de coordenadas reales de colecta.", "Planilla sin campos de latitud/longitud o campos GMS incompletos.", "Latitud y longitud invertidas.", "Coordenadas sin hemisferio cuando se usan campos GMS."],
                    exampleLabel: "Descargar planilla de ejemplo"
                },
                {
                    toolId: "specieslink-jabot",
                ...
                {
                    toolId: "evb-darwincore",
                    expectedInput: "Planillas autorales, planillas en el modelo JABOT o planillas parcialmente alineadas con Darwin Core, con datos botanicos, taxonomicos, geograficos y curatoriales.",
                    steps: ["Abra EVB DarwinCore.", "Cargue la planilla .xls, .xlsx o .csv que desea estandarizar.", "Elija el perfil automatico, JABOT, autoral o Darwin Core parcial.", "Complete los metadatos principales del conjunto como datasetName, institutionCode, collectionCode, basisOfRecord, license y rightsHolder.", "Ejecute la conversion para generar la planilla Darwin Core con campos verbatim preservados.", "Revise la vista previa, las alertas locales y la hoja de mapeo antes de exportar el archivo final."],
                    commonErrors: ["scientificName ausente o armado solo parcialmente a partir de genus y epiteto.", "Coordenadas ausentes, invalidas o ubicadas en columnas inesperadas.", "Campos geograficos demasiado incompletos para poblar country, stateProvince, county y locality con seguridad.", "Planillas autorales con nombres de columnas muy particulares que exigen revision manual despues de la conversion."],
        ...
        serviceItems: [
            {
                ...
                description: "Espacio reservado para orientaciones generales destinadas a nuevos integrantes, pasantes, estudiantes de iniciación científica y colaboradores que comienzan a trabajar en el herbario.",
            ...
            },
            {
                ...
                description: "Espacio reservado para procedimientos de organización, digitalización, revisión de datos, manejo de duplicados, freezer, armarios y demás etapas de la rutina curatorial.",
                status: "EVB / UNILA"
            }
        ],
        orientationGuides: [
                ...
                sections: [
                    {
                        ...
                        body: [
                            "Espacio reservado para presentar la organización general del herbario, las áreas de trabajo, el equipo responsable y las primeras orientaciones para quienes comienzan sus actividades en el EVB.",
                            "Cuando la guía definitiva sea escrita, este capítulo podrá recibir fotos de la sala, armarios, área de selección y espacios de circulación."
                        ],
                        items: ["A quién contactar al llegar al herbario.", "Qué áreas pueden ser accedidas libremente.", "Qué actividades requieren supervisión del equipo."]
                    },
                    {
                    ...
                    },
                    {
                        ...
                        body: ["Espacio reservado para explicar cómo se distribuyen las actividades, cómo registrar tareas realizadas y cómo acompañar pendientes relacionadas con la colección, digitalización, organización y apoyo a la investigación."],
        ...
        infoPages: [
            ...
            },
            {
                ...
                body: [
                    "Esta sección no representa una oferta de servicios externos. Fue pensada como una puerta de entrada para estudiantes, pasantes, becarios y colaboradores que necesitan comprender las rutinas básicas del herbario.",
...
const localizedToolLongDescriptions = {
    en: {
        ...
        `,
        "mapa-coordenadas": `
            <p><strong>Map & Coordinates</strong> concentrates spatial checking and coordinate conversion in an independent interface.</p>
            ...
            <p>The coordinate converter works with individual coordinates and batches, making it useful for field checking, spreadsheet cleanup and preparation of spatial data for other analyses.</p>
        `,
        "specieslink-jabot": `
        ...
        "evb-darwincore": `
            ...
            <p>This first version is meant to solve the structural core of the problem: moving internal working spreadsheets into a more universal format for display, exchange and sharing, while preserving the trace of what was originally written.</p>
            ...
            <p>The current version accepts <strong>.xls</strong>, <strong>.xlsx</strong> and <strong>.csv</strong> files, auto-detects the input profile and works especially well with JABOT spreadsheets and authorial spreadsheets that have minimally recognizable taxonomic, geographic and curatorial columns.</p>
            <p>During conversion, the tool builds a Darwin Core table with immediate preview, creates an auxiliary mapping sheet between source columns and final terms, produces a local validation report and allows export in <strong>.xlsx</strong> or <strong>.csv</strong>.</p>
    ...
    es: {
        ...
        `,
        "analise-botanica": `
            <p><strong>EVB DataCheck</strong> genera estadísticas descriptivas a partir de un conjunto de ejemplares definido por el usuario.</p>
        ...
        `,
        "mapa-coordenadas": `
            <p><strong>Mapa y Coordenadas</strong> concentra la revisión espacial y la conversión de coordenadas en una interfaz independiente.</p>
            ...
            <p>El mapa incluye capas base, visualizacion satelital, agrupamiento de puntos, filtros, busqueda, leyenda interactiva y lista de puntos visibles. La tabla cargada puede visualizarse debajo del mapa y copiarse para revision en planillas externas.</p>
        ...
        "evb-darwincore": `
            ...
            <p>El objetivo principal de esta primera version es automatizar el paso de un formato interno de trabajo a un formato mas universal de exhibicion, intercambio y comparticion de datos, sin perder el rastro de lo que estaba escrito originalmente.</p>
            <p>Por eso la herramienta preserva siempre que es posible campos <strong>verbatim</strong>, especialmente los relacionados con nombre cientifico, fecha, localidad y coordenadas. Al mismo tiempo que produce columnas estandarizadas de Darwin Core, conserva la forma original del dato cuando esa informacion existe o puede reconstruirse con seguridad.</p>
            <p>La version actual acepta archivos <strong>.xls</strong>, <strong>.xlsx</strong> y <strong>.csv</strong>, intenta reconocer automaticamente el perfil de entrada y funciona especialmente bien con planillas JABOT y planillas autorales con columnas taxonomicas, geograficas y curatoriales minimamente reconocibles.</p>
            <p>Durante la conversion, la herramienta genera una planilla Darwin Core con vista previa inmediata, una hoja auxiliar de mapeo entre columnas de origen y terminos finales, un informe local de validacion y la exportacion final en <strong>.xlsx</strong> o <strong>.csv</strong>.</p>
            <p>Esta primera etapa todavia no sustituye una validacion taxonomica mas robusta. Entrega la capa estructural: estandarizacion, preservacion de verbatim, revision local y preparacion del conjunto para pasos posteriores, como matching taxonomico, chequeo contra backbone externo y revision orientada a publicacion.</p>
        `
    }
};
