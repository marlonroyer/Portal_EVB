...
const tools = [
    ...
    },
    {
        ...
        description: "Plota coordenadas em mapa interativo, confere dados espaciais, cruza pontos com camadas e converte coordenadas entre decimal e graus, minutos e segundos.",
        accepts: "Planilhas .xls, .xlsx ou .csv com coordenadas decimais ou campos em graus, minutos e segundos, camadas auxiliares em GeoJSON/JSON/ZIP e o ZIP oficial CNUC/SNUC para Unidades de Conservação.",
        output: "Mapa interativo, tabela JABOT copiável, conversões de coordenadas e planilha .xlsx com a coluna uc preenchida quando pontos caem em Unidades de Conservação.",
        status: "Beta",
        version: "1.0",
...
const toolLongDescriptions = {
    ...
    `,
    "mapa-coordenadas": `
        <p>A ferramenta <strong>Mapa & Coordenadas</strong> foi criada para concentrar as funções espaciais em uma interface própria, independente da Análise Botânica.</p>
        ...
        <p>O mapa possui camadas base, visualização por satélite, agrupamento de pontos, filtros, busca, legenda interativa, lista de pontos visíveis e importação de camadas espaciais em <strong>GeoJSON</strong>, <strong>JSON</strong> ou shapefile compactado em <strong>ZIP</strong>.</p>
        <p>Um recurso específico permite carregar a camada oficial de Unidades de Conservação do <strong>CNUC/SNUC</strong>. Quando essa camada é importada, a ferramenta cruza os pontos da planilha com os polígonos das UCs e preenche automaticamente a coluna <strong>uc</strong> na tabela JABOT, permitindo copiar a tabela enriquecida ou exportar uma nova planilha <strong>.xlsx</strong> com relatório auxiliar.</p>
        ...
        <p>Esse módulo é útil tanto para revisão de planilhas botânicas quanto para tarefas rápidas de georreferenciamento, conferência de campo, organização de coordenadas e preparação de dados espaciais para outras análises.</p>
    `,
    "specieslink-jabot": `
...
const toolHelp = {
    flow: [
        ...
        },
        {
            ...
            text: "Plote pontos, converta coordenadas, importe camadas espaciais e preencha a coluna uc a partir da camada oficial CNUC/SNUC."
        },
        {
            step: "6",
    ...
    tools: [
        ...
        },
        {
            ...
            expectedInput: "Planilha .xls, .xlsx ou .csv com coordenadas decimais ou campos GMS do modelo JABOT. Para preencher a coluna uc, carregue tambem o ZIP oficial CNUC/SNUC pelo botao Importar UC/SNUC.",
            steps: [
                ...
                "Para Unidades de Conservacao, baixe o ZIP CNUC/SNUC pelo link oficial indicado na ferramenta.",
                "Importe o arquivo pelo botao Importar UC/SNUC.",
                "Confira a tabela JABOT abaixo do mapa e copie ou exporte a planilha com a coluna uc preenchida.",
                "Use o conversor individual ou em lote quando precisar padronizar coordenadas."
            ],
            commonErrors: [
                "Carregar uma camada auxiliar no lugar do botao Importar UC/SNUC e esperar que ela preencha a coluna uc.",
    ...
    en: {
        tools: [
            ...
            },
            {
                ...
                description: "Plots coordinates on an interactive map, checks spatial data, intersects points with spatial layers and converts coordinates between decimal and DMS.",
                accepts: ".xls, .xlsx or .csv spreadsheets with decimal coordinates or DMS fields, auxiliary GeoJSON/JSON/ZIP layers and the official CNUC/SNUC ZIP for protected areas.",
                output: "Interactive map, copy-ready JABOT table, coordinate conversions and .xlsx spreadsheet with the uc column filled when points fall inside protected areas.",
                status: "Beta",
                exampleLabel: "Sample spreadsheet"
            },
            {
        ...
        toolHelp: {
            flow: [
                ...
                { step: "5", title: "Check coordinates", tool: "Map & Coordinates", text: "Plot records, convert coordinates, import spatial layers and fill the uc column using the official CNUC/SNUC layer." },
            ...
            tools: [
                ...
                {
                    toolId: "mapa-coordenadas",
                    expectedInput: ".xls, .xlsx or .csv spreadsheet with decimal coordinates or JABOT DMS fields. To fill the uc column, also load the official CNUC/SNUC ZIP through the Import UC/SNUC button.",
                    steps: ["Open Map & Coordinates.", "Load the JABOT spreadsheet or another spreadsheet with recognizable coordinates.", "Check points, filters, search and spatial completeness on the map.", "For protected areas, download the CNUC/SNUC ZIP using the official link shown in the tool.", "Import it with the Import UC/SNUC button.", "Review the JABOT table below the map and copy or export the spreadsheet with the uc column filled.", "Use the individual or batch converter when coordinates need standardization."],
                    commonErrors: ["Loading an auxiliary layer instead of using Import UC/SNUC and expecting it to fill the uc column.", "Using municipality-level coordinates instead of real collection coordinates.", "Spreadsheet without latitude/longitude fields or incomplete DMS fields.", "Very large spatial layers slowing down the interface."],
                    exampleLabel: "Download sample spreadsheet"
                },
                {
                    toolId: "specieslink-jabot",
    ...
    es: {
        tools: [
            ...
            },
            {
                ...
                description: "Representa coordenadas en un mapa interactivo, revisa datos espaciales, cruza puntos con capas y convierte coordenadas entre decimal y GMS.",
                accepts: "Planillas .xls, .xlsx o .csv con coordenadas decimales o campos GMS, capas auxiliares GeoJSON/JSON/ZIP y el ZIP oficial CNUC/SNUC para Unidades de Conservación.",
                output: "Mapa interactivo, tabla JABOT lista para copiar, conversiones de coordenadas y planilla .xlsx con la columna uc completada cuando los puntos caen dentro de Unidades de Conservación.",
                status: "Beta",
                exampleLabel: "Planilla de ejemplo"
            },
            {
        ...
        toolHelp: {
            flow: [
                ...
                { step: "5", title: "Revisar coordenadas", tool: "Mapa y Coordenadas", text: "Represente puntos, convierta coordenadas, importe capas espaciales y complete la columna uc usando la capa oficial CNUC/SNUC." },
            ...
            tools: [
                ...
                {
                    toolId: "mapa-coordenadas",
                    expectedInput: "Planilla .xls, .xlsx o .csv con coordenadas decimales o campos GMS del modelo JABOT. Para completar la columna uc, cargue también el ZIP oficial CNUC/SNUC con el botón Importar UC/SNUC.",
                    steps: ["Abra Mapa y Coordenadas.", "Cargue la planilla JABOT u otra planilla con coordenadas reconocibles.", "Revise los puntos, filtros, búsqueda y completitud espacial en el mapa.", "Para Unidades de Conservación, descargue el ZIP CNUC/SNUC desde el enlace oficial indicado en la herramienta.", "Impórtelo con el botón Importar UC/SNUC.", "Revise la tabla JABOT debajo del mapa y copie o exporte la planilla con la columna uc completada.", "Use el conversor individual o por lote cuando necesite estandarizar coordenadas."],
                    commonErrors: ["Cargar una capa auxiliar en lugar de usar Importar UC/SNUC y esperar que complete la columna uc.", "Usar coordenadas generales de municipio en vez de coordenadas reales de colecta.", "Planilla sin campos de latitud/longitud o campos GMS incompletos.", "Capas espaciales muy grandes que hacen lenta la interfaz."],
                    exampleLabel: "Descargar planilla de ejemplo"
                },
                {
                    toolId: "specieslink-jabot",
...
const localizedToolLongDescriptions = {
    en: {
        ...
        "mapa-coordenadas": `
            ...
            <p>The map includes base layers, satellite view, clustering, filters, search, an interactive legend, visible point lists and support for auxiliary spatial layers in <strong>GeoJSON</strong>, <strong>JSON</strong> or zipped shapefile format.</p>
            <p>A dedicated module imports the official <strong>CNUC/SNUC</strong> protected-area layer. When this layer is loaded, the tool intersects specimen points with protected-area polygons and fills the <strong>uc</strong> column in the JABOT table. The enriched table can be copied or exported as a new <strong>.xlsx</strong> file with an auxiliary report.</p>
    ...
    es: {
        ...
        "mapa-coordenadas": `
            ...
            <p>El mapa incluye capas base, visualización satelital, agrupamiento de puntos, filtros, búsqueda, leyenda interactiva, lista de puntos visibles y soporte para capas espaciales auxiliares en formato <strong>GeoJSON</strong>, <strong>JSON</strong> o shapefile comprimido en <strong>ZIP</strong>.</p>
            <p>Un módulo específico importa la capa oficial de Unidades de Conservación del <strong>CNUC/SNUC</strong>. Cuando esa capa se carga, la herramienta cruza los puntos de la planilla con los polígonos de las unidades y completa la columna <strong>uc</strong> en la tabla JABOT. La tabla enriquecida puede copiarse o exportarse como una nueva planilla <strong>.xlsx</strong> con un informe auxiliar.</p>
