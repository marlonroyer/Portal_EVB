...
const tools = [
    ...
    },
    {
        ...
        description: "Plota coordenadas em mapa interativo, permite filtrar e buscar registros, avalia completude espacial e converte coordenadas entre decimal e graus, minutos e segundos.",
        accepts: "Planilhas .xls, .xlsx ou .csv com coordenadas decimais ou campos em graus, minutos e segundos.",
        output: "Mapa interativo, tabela copiavel, lista de pontos, filtros, busca, legenda dinamica, relatorio espacial e conversoes de coordenadas.",
        status: "Estavel",
        version: "2.0",
...
const toolLongDescriptions = {
    ...
    "mapa-coordenadas": `
        ...
        <p>O mapa possui camadas base, visualizacao por satelite, agrupamento de pontos, filtros, busca, legenda interativa e lista de pontos visiveis. A tabela carregada pode ser visualizada abaixo do mapa e copiada para revisao em planilhas externas.</p>
