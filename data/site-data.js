...
const infoPages = [
    ...
    },
    {
        ...
        body: [
            "O mapa reproduz a organização física da coleção e permite navegar pelos armários A1 a A8, prateleiras, espaços e caixas, mantendo a leitura visual próxima da disposição real do acervo.",
            "A busca localiza caixas por número, família, gênero, conteúdo ou posição física. Quando a base DwC-A do EVB é carregada, a ferramenta também pode buscar por número de tombo ou nome científico, recuperar dados do exemplar e estimar a caixa mais provável com base na família e nos intervalos alfabéticos dos pacotes.",
            "Os dados do mapa podem ser atualizados a partir da planilha publicada no Google Sheets, preservando uma cópia local para consulta quando a atualização online não estiver disponível."
        ],
        ...
        collectionMap: {
            ...
            dwcaDownloadUrl: "https://ipt.jbrj.gov.br/reflora/archive.do?r=evb",
            dwcaDownloadLabel: "Baixar base IPT",
            ...
            dwcaError: "Não foi possível ler a base DwC-A. Confira se o arquivo carregado é o ZIP baixado do IPT/Reflora EVB.",
        ...
        infoPages: [
            ...
            },
            {
                ...
                collectionMap: {
                    ...
                    dwcaDownloadUrl: "https://ipt.jbrj.gov.br/reflora/archive.do?r=evb",
                    dwcaDownloadLabel: "Download IPT base",
                    ...
                    dwcaError: "Could not read the DwC-A base. Check whether the loaded file is the ZIP downloaded from IPT/Reflora EVB.",
        ...
        infoPages: [
            ...
            },
            {
                ...
                collectionMap: {
                    ...
                    dwcaDownloadUrl: "https://ipt.jbrj.gov.br/reflora/archive.do?r=evb",
                    dwcaDownloadLabel: "Descargar base IPT",
                    ...
                    dwcaError: "No fue posible leer la base DwC-A. Verifique si el archivo cargado es el ZIP descargado de IPT/Reflora EVB.",
