    ...
    en: {
        ...
        toolHelp: {
            flow: [
                ...
                { step: "5", title: "Check coordinates", tool: "EVB GeoCheck", text: "Plot records, review spatial completeness, filter points and convert coordinates in decimal or DMS format." },
    ...
    es: {
        ...
        toolHelp: {
            flow: [
                ...
                { step: "5", title: "Revisar coordenadas", tool: "EVB GeoCheck", text: "Represente puntos, revise la completitud espacial, filtre registros y convierta coordenadas en formato decimal o GMS." },
            ...
            tools: [
                ...
                },
                {
                    ...
                    steps: ["Abra EVB GeoCheck.", "Cargue la planilla JABOT u otra planilla con coordenadas reconocibles.", "Revise los puntos, filtros, busqueda y completitud espacial en el mapa.", "Revise la tabla debajo del mapa y copiela cuando necesite revisar los datos externamente.", "Use el conversor individual o por lote cuando necesite estandarizar coordenadas."],
...
const localizedToolLongDescriptions = {
    en: {
        ...
        `,
        "mapa-coordenadas": `
            <p><strong>EVB GeoCheck</strong> concentrates spatial checking and coordinate conversion in an independent interface.</p>
